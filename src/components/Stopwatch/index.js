...
class Stopwatch extends Component {
  ...
  // spelling like componentWillUnmount

  componentWillUnmount() {
    // FIX2: When the setInterval method is used,use clearInterval method to clear the scheduler

    clearInterval(this.timeInterval)
  }

  onResetTimer = () => {
    // FIX3: class variables should be using "this" keyword
    clearInterval(this.timeInterval)
    // FIX4: when the "Reset" button is clicked timer should be reset to 0
  ...
  updateTime = () => {
    this.setState(prevState => ({
      // FIX5:prevState should be used to update the state
  ...
  onStartTimer = () => {
    ...
    // FIX8: using "this" keyword like this.updateTime
